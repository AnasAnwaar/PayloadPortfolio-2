...
export const projectSeeds = [
  {
    ...
    contributors: [{ name: 'M Anas Anwaar', role: 'Full-Stack Developer & AI Engineer', type: 'Personal Project', linkedIn: 'https://linkedin.com/in/syed-ibad-developer' }], order: 1,
  },
...
export const portfolioSeed = {
  identity: { name: 'M Anas Anwaar', initials: 'MA', professionalTitle: 'Backend Engineer', shortBio: 'Backend Engineer building scalable solutions with Node.js, Python, and AI/ML. Passionate about teaching and creating impact through technology.' },
  ...
  footer: { description: 'Backend Engineer building scalable solutions with Node.js, Python, and AI/ML.', copyright: '© 2026 M Anas Anwaar. All rights reserved.' },
