...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.run(sql`CREATE TABLE \`portfolio_projects_external_links\` (
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_projects_external_links_order_idx\` ON \`portfolio_projects_external_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_external_links_parent_id_idx\` ON \`portfolio_projects_external_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_projects_features\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_projects_features_order_idx\` ON \`portfolio_projects_features\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_features_parent_id_idx\` ON \`portfolio_projects_features\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_projects_screenshots\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_projects_screenshots_order_idx\` ON \`portfolio_projects_screenshots\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_screenshots_parent_id_idx\` ON \`portfolio_projects_screenshots\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_screenshots_image_idx\` ON \`portfolio_projects_screenshots\` (\`image_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_projects_contributors\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`name\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_projects_contributors_order_idx\` ON \`portfolio_projects_contributors\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_contributors_parent_id_idx\` ON \`portfolio_projects_contributors\` (\`_parent_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_contributors_avatar_idx\` ON \`portfolio_projects_contributors\` (\`avatar_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_projects\` (
  	...
  	\`case_study_technical_implementation\` text,
  	\`case_study_impact\` text,
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`portfolio_projects_slug_idx\` ON \`portfolio_projects\` (\`slug\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_category_idx\` ON \`portfolio_projects\` (\`category_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_hero_media_idx\` ON \`portfolio_projects\` (\`hero_media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`portfolio_projects_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	...
  	FOREIGN KEY (\`parent_id\`) REFERENCES \`portfolio_projects\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`skills_id\`) REFERENCES \`skills\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`portfolio_projects_id\`) REFERENCES \`portfolio_projects\`(\`id\`) ON UPDATE no action ON DELETE cascade
  );
  `)
  await db.run(sql`CREATE INDEX \`portfolio_projects_rels_order_idx\` ON \`portfolio_projects_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_rels_parent_idx\` ON \`portfolio_projects_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_rels_path_idx\` ON \`portfolio_projects_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_rels_skills_id_idx\` ON \`portfolio_projects_rels\` (\`skills_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_projects_rels_portfolio_projects_id_idx\` ON \`portfolio_projects_rels\` (\`portfolio_projects_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`experiences_achievements\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`experiences_achievements_order_idx\` ON \`experiences_achievements\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`experiences_achievements_parent_id_idx\` ON \`experiences_achievements\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`experiences\` (
  	...
  	\`updated_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	\`created_at\` text DEFAULT (strftime('%Y-%m-%dT%H:%M:%fZ', 'now')) NOT NULL,
  	FOREIGN KEY (\`category_id\`) REFERENCES \`experience_categories\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`logo_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`experiences_category_idx\` ON \`experiences\` (\`category_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`experiences_rels\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`experiences_rels_order_idx\` ON \`experiences_rels\` (\`order\`);`)
  await db.run(sql`CREATE INDEX \`experiences_rels_parent_idx\` ON \`experiences_rels\` (\`parent_id\`);`)
  await db.run(sql`CREATE INDEX \`experiences_rels_path_idx\` ON \`experiences_rels\` (\`path\`);`)
  await db.run(sql`CREATE INDEX \`experiences_rels_skills_id_idx\` ON \`experiences_rels\` (\`skills_id\`);`)
  await db.run(sql`CREATE TABLE \`experience_categories\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  	\`generate_slug\` integer DEFAULT true,
  	\`slug\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`experience_categories_slug_idx\` ON \`experience_categories\` (\`slug\`);`)
  await db.run(sql`CREATE INDEX \`experience_categories_updated_at_idx\` ON \`experience_categories\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`experience_categories_created_at_idx\` ON \`experience_categories\` (\`created_at\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`skills_category_idx\` ON \`skills\` (\`category_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`skill_categories\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`title\` text NOT NULL,
  	\`generate_slug\` integer DEFAULT true,
  	\`slug\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE UNIQUE INDEX \`skill_categories_slug_idx\` ON \`skill_categories\` (\`slug\`);`)
  await db.run(sql`CREATE INDEX \`skill_categories_updated_at_idx\` ON \`skill_categories\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`skill_categories_created_at_idx\` ON \`skill_categories\` (\`created_at\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`achievements_media_idx\` ON \`achievements\` (\`media_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`payload_locked_documents_rels\` (
  	...
  	FOREIGN KEY (\`experience_categories_id\`) REFERENCES \`experience_categories\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`skills_id\`) REFERENCES \`skills\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  	FOREIGN KEY (\`skill_categories_id\`) REFERENCES \`skill_categories\`(\`id\`) ON UPDATE no action ON DELETE cascade,
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_portfolio_projects_id_idx\` ON \`payload_locked_documents_rels\` (\`portfolio_projects_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_experience_categories_id_idx\` ON \`payload_locked_documents_rels\` (\`experience_categories_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_skills_id_idx\` ON \`payload_locked_documents_rels\` (\`skills_id\`);`)
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_skill_categories_id_idx\` ON \`payload_locked_documents_rels\` (\`skill_categories_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`portfolio_navigation\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_navigation_order_idx\` ON \`portfolio_navigation\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_navigation_parent_id_idx\` ON \`portfolio_navigation\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_hero_taglines\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_hero_taglines_order_idx\` ON \`portfolio_hero_taglines\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_hero_taglines_parent_id_idx\` ON \`portfolio_hero_taglines\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_hero_roles\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`role\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_hero_roles_order_idx\` ON \`portfolio_hero_roles\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_hero_roles_parent_id_idx\` ON \`portfolio_hero_roles\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_about_paragraphs\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`text\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_about_paragraphs_order_idx\` ON \`portfolio_about_paragraphs\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_about_paragraphs_parent_id_idx\` ON \`portfolio_about_paragraphs\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_about_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`value\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_about_stats_order_idx\` ON \`portfolio_about_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_about_stats_parent_id_idx\` ON \`portfolio_about_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_achievement_stats\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`value\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_achievement_stats_order_idx\` ON \`portfolio_achievement_stats\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_achievement_stats_parent_id_idx\` ON \`portfolio_achievement_stats\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_contact_availability_tags\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_contact_availability_tags_order_idx\` ON \`portfolio_contact_availability_tags\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_contact_availability_tags_parent_id_idx\` ON \`portfolio_contact_availability_tags\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_contact_social_links\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`label\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_contact_social_links_order_idx\` ON \`portfolio_contact_social_links\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_contact_social_links_parent_id_idx\` ON \`portfolio_contact_social_links\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio_seo_keywords\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`tag\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`portfolio_seo_keywords_order_idx\` ON \`portfolio_seo_keywords\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_seo_keywords_parent_id_idx\` ON \`portfolio_seo_keywords\` (\`_parent_id\`);`)
  await db.run(sql`CREATE TABLE \`portfolio\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`identity_name\` text NOT NULL,
  	\`identity_initials\` text NOT NULL,
  	\`identity_professional_title\` text NOT NULL,
  	\`identity_short_bio\` text,
  	\`identity_profile_image_id\` integer,
  	\`identity_resume_id\` integer,
  	\`hero_availability\` text,
  	\`hero_eyebrow\` text DEFAULT 'Hi, I''m',
  	\`hero_headline\` text NOT NULL,
  	\`hero_primary_button_label\` text DEFAULT 'View My Work',
  	\`hero_secondary_button_label\` text DEFAULT 'Let''s Connect',
  	\`hero_tech_label\` text DEFAULT 'Tech I love working with',
  	\`about_heading\` text NOT NULL,
  	\`about_description\` text NOT NULL,
  	\`about_experience_badge\` text,
  	\`about_location\` text,
  	\`about_email\` text,
  	\`about_phone\` text,
  	\`experience_section_heading\` text NOT NULL,
  	\`experience_section_description\` text NOT NULL,
  	\`skills_section_heading\` text NOT NULL,
  	\`skills_section_description\` text NOT NULL,
  	\`projects_section_heading\` text NOT NULL,
  	\`projects_section_description\` text NOT NULL,
  	\`achievements_section_heading\` text NOT NULL,
  	\`achievements_section_description\` text NOT NULL,
  	\`contact_heading\` text NOT NULL,
  	\`contact_description\` text NOT NULL,
  	\`contact_form_heading\` text DEFAULT 'Send a Message',
  	\`contact_response_note\` text,
  	\`contact_email\` text,
  	\`contact_phone\` text,
  	\`contact_location\` text,
  	\`contact_availability_heading\` text,
  	\`contact_availability_text\` text,
  	...
  	\`updated_at\` text,
  	\`created_at\` text,
  	FOREIGN KEY (\`identity_profile_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`identity_resume_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null,
  	FOREIGN KEY (\`seo_og_image_id\`) REFERENCES \`media\`(\`id\`) ON UPDATE no action ON DELETE set null
  );
  `)
  await db.run(sql`CREATE INDEX \`portfolio_identity_identity_profile_image_idx\` ON \`portfolio\` (\`identity_profile_image_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_identity_identity_resume_idx\` ON \`portfolio\` (\`identity_resume_id\`);`)
  await db.run(sql`CREATE INDEX \`portfolio_seo_seo_og_image_idx\` ON \`portfolio\` (\`seo_og_image_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`portfolio_rels_skills_id_idx\` ON \`portfolio_rels\` (\`skills_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.run(sql`DROP TABLE \`portfolio_projects_external_links\`;`)
  await db.run(sql`DROP TABLE \`portfolio_projects_features\`;`)
  await db.run(sql`DROP TABLE \`portfolio_projects_screenshots\`;`)
  await db.run(sql`DROP TABLE \`portfolio_projects_contributors\`;`)
  await db.run(sql`DROP TABLE \`portfolio_projects\`;`)
  await db.run(sql`DROP TABLE \`portfolio_projects_rels\`;`)
  await db.run(sql`DROP TABLE \`project_categories\`;`)
  await db.run(sql`DROP TABLE \`experiences_achievements\`;`)
  await db.run(sql`DROP TABLE \`experiences\`;`)
  await db.run(sql`DROP TABLE \`experiences_rels\`;`)
  await db.run(sql`DROP TABLE \`experience_categories\`;`)
  await db.run(sql`DROP TABLE \`skills\`;`)
  await db.run(sql`DROP TABLE \`skill_categories\`;`)
  ...
  await db.run(sql`DROP TABLE \`portfolio_navigation\`;`)
  await db.run(sql`DROP TABLE \`portfolio_hero_taglines\`;`)
  await db.run(sql`DROP TABLE \`portfolio_hero_roles\`;`)
  await db.run(sql`DROP TABLE \`portfolio_about_paragraphs\`;`)
  await db.run(sql`DROP TABLE \`portfolio_about_stats\`;`)
  await db.run(sql`DROP TABLE \`portfolio_achievement_stats\`;`)
  await db.run(sql`DROP TABLE \`portfolio_contact_availability_tags\`;`)
  await db.run(sql`DROP TABLE \`portfolio_contact_social_links\`;`)
  await db.run(sql`DROP TABLE \`portfolio_seo_keywords\`;`)
