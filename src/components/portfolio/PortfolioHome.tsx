  ...
  return (
    <main className="min-h-screen overflow-hidden bg-page text-ink">
      ...
      <section className="scroll-mt-24 px-5 py-24" id="contact"><div className="mx-auto max-w-[1280px]"><SectionHeading description={content.contact.description} heading={content.contact.heading} /><div className="grid items-start gap-8 lg:grid-cols-2">
        <form className="rounded-2xl border border-line bg-raised p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:border-mint/50 hover:shadow-xl md:p-8" onSubmit={submitContact}><div className="flex items-center gap-4"><span className="rounded-xl bg-mint p-3 text-page"><MessageSquare /></span><div><h3 className="text-xl font-bold">{content.contact.formHeading}</h3><p className="text-sm text-ink-soft">{content.contact.responseNote}</p></div></div><label className="mt-7 block text-sm font-medium">Your Name<input className="mt-2 w-full rounded-xl border border-line bg-white px-4 py-3.5 outline-none transition placeholder:text-ink-soft/70 focus:border-mint focus:ring-2 focus:ring-mint/20" name="name" placeholder="John Doe" required /></label><label className="mt-5 block text-sm font-medium">Email Address<input className="mt-2 w-full rounded-xl border border-line bg-white px-4 py-3.5 outline-none transition placeholder:text-ink-soft/70 focus:border-mint focus:ring-2 focus:ring-mint/20" name="email" placeholder="john@example.com" required type="email" /></label><label className="mt-5 block text-sm font-medium">Your Message<textarea className="mt-2 min-h-36 w-full rounded-xl border border-line bg-white px-4 py-3.5 outline-none transition placeholder:text-ink-soft/70 focus:border-mint focus:ring-2 focus:ring-mint/20" name="message" placeholder="Tell me about your project or just say hello..." required /></label><button className="mt-6 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-mint py-3.5 font-bold text-page" type="submit"><Send size={18} /> Send Message</button></form>
