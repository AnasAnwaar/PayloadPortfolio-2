...
export interface PortfolioProject {
  ...
  contributors?:
    ...
    | null;
  relatedProjects?: (number | PortfolioProject)[] | null;
  order: number;
  updatedAt: string;
  createdAt: string;
}
...
export interface ProjectCategory {
  ...
  generateSlug?: boolean | null;
  slug: string;
  color?: ('cyan' | 'blue' | 'purple' | 'amber' | 'green') | null;
  order?: number | null;
  updatedAt: string;
  createdAt: string;
}
...
export interface SkillCategory {
  ...
  slug: string;
  /**
   * Lucide icon name, e.g. Server, Code2, Database.
   */
  icon?: string | null;
  order: number;
  updatedAt: string;
...
export interface Experience {
  ...
  title: string;
  company: string;
  category: number | ExperienceCategory;
...
export interface Achievement {
  id: number;
  title: string;
  kind: 'highlight' | 'certification';
  /**
   * e.g. competition, workshop, participation.
   */
  badge?: string | null;
  issuer?: string | null;
  description?: string | null;
...
export interface Portfolio {
  ...
  hero: {
    ...
    featuredSkills?: (number | Skill)[] | null;
  };
  about: {
    heading: string;
    description: string;
  ...
  achievementStats?:
    | {
        value: string;
        label: string;
        color?: ('cyan' | 'purple' | 'amber' | 'green') | null;
        id?: string | null;
      }[]
    | null;
  contact: {
